                  ...
                  <div className="form-field">
                    ...
                    {isAgeErrorVisible && getSelectedProgram() && (
                      <span className="inline-error">
                        Age must be between {getSelectedProgram()?.min_age} and{" "}
                        {getSelectedProgram()?.max_age}
                      </span>
                    )}
                  </div>
                  <div className="form-field">
                    <label>Age</label>
                    <input readOnly placeholder="Age" value={form.age || ""} />
                  </div>
                  <div className="form-field">
                    <label>Phone *</label>
                ...
                <div className="form two-col">
                  ...
                  {program === "thahfeez" && (
                    <>
                      ...
                      <div className="file-upload">
                        <label className="file-label" htmlFor="thahfeez-upload">
                          📎 Upload Achievements (Optional)
                        </label>
                        <input
                          type="file"
              ...
              <>
                ...
                <div className="review-sections">
                  ...
                  <div className="review-card">
                    ...
                    <p>
                      <strong>DOB:</strong> {form.dob}, <strong>Age:</strong>{" "}
                      {form.age}
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>Address:</strong> {form.houseName}, {form.place},{" "}
                      {form.postOffice} - {form.zipCode}
                    </p>
                    <p>
                  ...
                  <div className="review-card">
                    ...
                    <p>
                      <strong>Phone:</strong> {countryCode} {form.guardianPhone}
                    </p>
                    <p>
